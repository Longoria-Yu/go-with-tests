...
func TestHello(t *testing.T) {
	...
	t.Run("saying hello in Spanihs", func(t *testing.T) {
		actual := Hello("Longoria", "Spanish")
		expected := "Hola, Longoria"
		assertCorrectMessage(t, actual, expected)
	})

	t.Run("saying hello in French", func(t *testing.T) {
		actual := Hello("Longoria", "French")
		expected := "Bonjour, Longoria"
		assertCorrectMessage(t, actual, expected)
	})
}
